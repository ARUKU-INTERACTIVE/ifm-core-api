...
export class InitDb1741612330662 implements MigrationInterface {
  name = 'InitDb1741612330662';
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`DROP TABLE "ifm"."user"`);
