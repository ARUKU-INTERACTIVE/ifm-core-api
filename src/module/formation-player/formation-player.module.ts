import { FormationPlayerPostgresRepository } from '@module/formation-player/infrastructure/database/formation-player.postgres.repository';
...
const RepositoryProvider: Provider = {
  ...
  useClass: FormationPlayerPostgresRepository,
};
...
@Module({
  ...
  controllers: [],
  exports: [FormationPlayerService, FormationPlayerMapper, RepositoryProvider],
})
